...
*Details*      : [CHECKOUT_RELEASE1_8](https://github.com/CCRobot/TestResults/blob/20180103T042240RL18_DBG_F2_ubuntu/CHECKOUT_RELEASE1_8_0.md)   
*Exit Code*    : 0   

   
### Alias [ BUILD_STEP_UBUNTU ]   
*Test Command* : `./build.sh --static --debug -j=3`   
*Details*      : [BUILD_STEP_UBUNTU](https://github.com/CCRobot/TestResults/blob/20180103T042240RL18_DBG_F2_ubuntu/BUILD_STEP_UBUNTU_1.md)   
*Exit Code*    : 0   
...
*Details*      : [TEST_STEP](https://github.com/CCRobot/TestResults/blob/20180103T042240RL18_DBG_F2_ubuntu/TEST_STEP_3.md)   
*Exit Code*    : 1   

   
### Alias [ VM ]   
*Test Command* : `stdout && stderr`   
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20180103T042240RL18_DBG_F2_ubuntu/VM_4.md)   
*Exit Code*    : 0   
