...
*Details*      : [BUILD_STEP_OSX](https://github.com/CCRobot/TestResults/blob/20180110T111433exprgen-ext_osx/BUILD_STEP_OSX_1.md)   
*Exit Code*    : 0   

   
### Alias [ RUN_EXPRGEN ]   
*Test Command* : `mono Exprgen.exe -trace:3 -arch:x86_64 && echo ''`   
*Details*      : [RUN_EXPRGEN](https://github.com/CCRobot/TestResults/blob/20180110T111433exprgen-ext_osx/RUN_EXPRGEN_4.md)   
*Exit Code*    : 0   
...
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20180110T111433exprgen-ext_osx/VM_12.md)   
*Exit Code*    : 0   
