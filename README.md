...
*Details*      : [CHECKOUT_RELEASE1_8](https://github.com/CCRobot/TestResults/blob/20180207T002654RL18_DBG_F2_osx/CHECKOUT_RELEASE1_8_0.md)   
*Exit Code*    : 0   
...
*Details*      : [BUILD_STEP_OSX](https://github.com/CCRobot/TestResults/blob/20180207T002654RL18_DBG_F2_osx/BUILD_STEP_OSX_2.md)   
*Exit Code*    : 0   
...
*Details*      : [TEST_STEP](https://github.com/CCRobot/TestResults/blob/20180207T002654RL18_DBG_F2_osx/TEST_STEP_3.md)   
*Exit Code*    : 0   

   
### Alias [ VM ]   
*Test Command* : `stdout && stderr`   
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20180207T002654RL18_DBG_F2_osx/VM_4.md)   
*Exit Code*    : 0   
