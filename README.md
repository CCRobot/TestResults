### Test Results [`exprgen-ext2_ubuntu`]   
*Target* -> `ubuntu`   
`Test was FAILED`

### Alias [ BUILD_STEP_UBUNTU ]   
*Test Command* : `./build.sh --static --debug -j=3`   
*Details*      : [BUILD_STEP_UBUNTU](https://github.com/CCRobot/TestResults/blob/20180104T180531exprgen-ext2_ubuntu/BUILD_STEP_UBUNTU_0.md)   
*Exit Code*    : 0   
...
*Details*      : [RUN_EXPRGEN](https://github.com/CCRobot/TestResults/blob/20180104T180531exprgen-ext2_ubuntu/RUN_EXPRGEN_4.md)   
*Exit Code*    : 1   
...
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20180104T180531exprgen-ext2_ubuntu/VM_12.md)   
*Exit Code*    : 0   
