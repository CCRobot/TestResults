### Test Results [`exprgen-one_ubuntu`]   
*Target* -> `ubuntu`   
`Test was SUCCESSFUL`

### Alias [ BUILD_STEP_UBUNTU ]   
*Test Command* : `./build.sh --static --debug -j=3`   
*Details*      : [BUILD_STEP_UBUNTU](https://github.com/CCRobot/TestResults/blob/20180120T021807exprgen-one_ubuntu/BUILD_STEP_UBUNTU_0.md)   
*Exit Code*    : 0   
...
*Details*      : [RUN_EXPRGEN](https://github.com/CCRobot/TestResults/blob/20180120T021807exprgen-one_ubuntu/RUN_EXPRGEN_4.md)   
*Exit Code*    : 0   
...
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20180120T021807exprgen-one_ubuntu/VM_12.md)   
*Exit Code*    : 0   
