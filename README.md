### Test Results [`exprgen-ext_ubuntu`]   
*Target* -> `ubuntu`   
`Test was FAILED`

### Alias [ BUILD_STEP_UBUNTU ]   
*Test Command* : `./build.sh --static --debug -j=3`   
*Details*      : [BUILD_STEP_UBUNTU](https://github.com/CCRobot/TestResults/blob/20171228T180507exprgen-ext_ubuntu/BUILD_STEP_UBUNTU_0.md)   
*Exit Code*    : 0   
...
*Details*      : [WRITE_CONFIG](https://github.com/CCRobot/TestResults/blob/20171228T180507exprgen-ext_ubuntu/WRITE_CONFIG_3.md)   
*Exit Code*    : 1   
...
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20171228T180507exprgen-ext_ubuntu/VM_12.md)   
*Exit Code*    : 0   
