...
*Details*      : [CHECKOUT_RELEASE1_8](https://github.com/CCRobot/TestResults/blob/20180101T034410RL18_DBG_F2_ubuntu/CHECKOUT_RELEASE1_8_0.md)   
*Exit Code*    : 1   
...
*Details*      : [TEST_STEP] was not executed yet   

   
### Alias [ VM ]   
*Test Command* : `stdout && stderr`   
*Details*      : [VM](https://github.com/CCRobot/TestResults/blob/20180101T034410RL18_DBG_F2_ubuntu/VM_4.md)   
*Exit Code*    : 0   
